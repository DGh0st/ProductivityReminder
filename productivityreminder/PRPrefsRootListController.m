...
-(void)email{
	if([MFMailComposeViewController canSendMail]){
		...
		[email addAttachmentData:[NSData dataWithContentsOfFile:@"/var/mobile/Library/Preferences/com.dgh0st.productivityreminder.plist"] mimeType:@"application/xml" fileName:@"Prefs.plist"];
